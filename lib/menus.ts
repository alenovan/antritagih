  ...
  const menuConfig = [
    ...
    },
    {
      ...
      menus: [
        ...
        //   href: "/master/agent",
        //   label: "Agent",
        //   active: pathname.includes("/master/agent"),
        //   icon: "heroicons-outline:user", // Agent icon
        //   submenus: [],
        // },
        // {
        //   id: "target-agent",
        //   href: "/master/target-agent",
        //   label: "Target Agent",
        //   active: pathname.includes("/master/target-agent"),
        //   icon: "heroicons-outline:eye", // Target Agent icon
        //   submenus: [],
        // },
      ],
    },
